...
class TopRatedTitleMoviesFragment : TitleMoviesFragment("Top Rated") {

    companion object {
        fun newInstance() = TopRatedTitleMoviesFragment()
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.topRatedMovies.observe(viewLifecycleOwner, object: Observer<List<Movie>> {
